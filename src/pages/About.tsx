    ...
    <main className="relative flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="max-w-5xl mx-auto text-center">
          <Reveal>
            ...
            <p className="mt-6 max-w-2xl mx-auto text-lg text-muted-foreground">
              Ceylon Voyage was founded in 2014 by a small group of locals who believed Sri Lanka
              deserved storytellers — not just tour operators. Every itinerary is a love letter to
      ...
      <section className="px-6 py-20 bg-muted/40">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10">
          {[
            {
              t: "Mission",
              d: "To craft journeys that reveal the soul of Sri Lanka — one tea hill, one temple, one tide at a time.",
            },
            {
              t: "Vision",
              d: "A travel experience so personal it feels less like a tour and more like coming home.",
            },
          ].map((b) => (
            <Reveal key={b.t}>
      ...
      <section className="px-6 py-24">
        <SectionHeader
          ...
          title={
            <>
              Discover our <em className="text-gradient not-italic">visual language</em>.
            </>
          }
        />
        <div className="text-center mt-8">
          <Link
            to="/brand"
            className="inline-flex items-center gap-2 rounded-full bg-foreground text-background px-6 py-3 text-sm font-semibold hover:bg-gradient-sunset hover:text-cream transition-all"
          >
            View Brand Kit
          </Link>
        </div>
